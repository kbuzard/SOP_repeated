...
ttw = (8*(1 + etw$root^E)-5)/(68-8*(1 + etw$root^E))
...
f <- function (e) fd*(CSxta + (1 + e^E)*PSxta + CSyta + PSyta + TRta) + (CSxta + (1 + e^E)*PSxta + CSyta + PSyta + TRta) - fd*(CSxtw + (1 + e^E)*PSxtw + CSytw + PSytw + TRtw) - ((1 + e^E)*((2 +2*(8*(1 + e^E)-5)/(68-8*(1 + e^E)))^2)/49 + .5*((3 -4*(8*(1 + e^E)-5)/(68-8*(1 + e^E)))^2)/49 + ((8*(1 + e^E)-5)/(68-8*(1 + e^E)) - 6*(8*(1 + e^E)-5)/(68-8*(1 + e^E))^2)/7 + CSyta + PSyta)
...
bl = ((2 +2*(8*(1 + ove$root^E)-5)/(68-8*(1 + ove$root^E)))^2)/49 - PSxta +ea + fdl*(PSxtw - etw$root - PSxta +ea)
