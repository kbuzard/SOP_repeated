...
\[
  \left(1-\mathrm{e}^{-r\Delta}\right) \left[\pi(\tau^b(0)) - \left(\pi(\tau^a_\text{NL}) - e_a \right) \right] + \mathrm{e}^{-r\Delta}\left(1-\mathrm{e}^{-r\Delta T}\right) \left[\pi(\tau^{tw}) - e_{tw} - \left(\pi(\tau^a_\text{NL}) - e_a \right) \right] 
\]
