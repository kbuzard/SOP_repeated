	...
	\item Checking that punishment (2) is incentive compatible given (4) and (5)
		\begin{itemize}
			...
			\item Lobby [(2) is incentive compatible given (4) and (5)]:
				\[
				  \pi(\tau^N) - e^N + \frac{\de - \de^{T+1}}{1-\de} \left[\pi(\tau^N) - e^N \right] + \de^{T+1} \pi(\tau^a) \geq \pi(\tau^D) -e^D + \frac{\de - \de^{T+1}}{1-\de} \left[\pi(\tau^a)\right]
				\]
...
\begin{itemize}
	\item Legislature's condition (for class 4 above):
		\[
		  \frac{1 - \de^{T}}{1-\de} W(\ga(e^N),\tau^N) + \de^{T} W(\ga(0),\tau^a) \geq W(\ga(e^N),\cdot) + \frac{\de - \de^{T+1}}{1-\de}W(\ga(e^N),\tau^N) + \de^{T+1} W(\ga(0),\tau^a) 
		\]
			\begin{itemize}
		...
		\item Lobby's condition (for class 5 above)
			\[
			  \frac{1 - \de^{T}}{1-\de} \left[\pi(\tau^N) - e^N \right] + \frac{\de^{T}}{1-\de}\pi(\tau^a) \geq \pi(\tau^D) -e^D + \frac{\de}{1-\de} \pi(\tau^a)
			\]
			\begin{itemize}
