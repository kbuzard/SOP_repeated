...
In particular, \citet{hungerford}, \citet{riezman1991}, and \citet{martinvergote} consider the impact of different assumptions about reactions and timing of punishments for deviations from agreements. Here, I study a very simple structure in which the trading partners remain in a symmetric trade war for a predetermined number of periods.
