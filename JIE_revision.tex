...
The above-explored symmetric Nash-reversion punishments are of course not the only possible punishments. This section explores an asymmetric punishment scheme in which welfare is reduced for both the legislature and the lobby in the defecting country. Although this type of punishment is not hard to find in practice, it is shown here that it allows for increased cooperation in the form of lower trade agreement tariffs.
