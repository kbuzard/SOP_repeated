...
[Insert information structure here]
\begin{itemize}
		\item Set up with: I'm looking at repeated game. Here's information set up.
		\item Add to equilibrium selection argument that players condition only on tariff levels	
	\item Within a period, players in same country take advantage of more information (leg knows what lobby did); players condition on what they know from that period and tariff level from past periods
		\begin{itemize}
			\item $\Rightarrow$ PPE from period to period
		\end{itemize}

\end{itemize}

As there is asymmetric information in that lobbying effort is not observed across borders, perfect public equilibrium (PPE) is the solution concept employed here. Whenever there is a possibility of multiple equilibria, I will focus on the one that maximizes the welfare of the executives. 
