...
\textbf{The stage-game timing is as follows. At time zero, the executives set trade policy cooperatively in an international agreement. In each subsequent period, the lobbies attempt to persuade the legislatures in their respective countries to break the trade agreement. Next, the legislatures decide whether to abide by the agreement or to provoke a trade war. In the event that neither of the lobbies exerts sufficient effort to induce its legislature to break the trade agreement, there is an applied tariff stage in which }
