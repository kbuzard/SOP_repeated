...
For Nash reversion punishments of length $T$, 
...
\subsection{I don't know what to call it yet}
...
Again, because of symmetry and separability, it suffices to restrict attention to the home country. 
...
In the event that at least one of the legislatures chooses a tariff greater than the trade agreement tariff, the trade agreement tariffs are suspended and the relationship moves into a punishment phase. There is no trade agreement to break, so lobbying simply influences the level at which the punishment phase tariff is set. %repeated game stuff, or possibly belongs only in sec:structure
