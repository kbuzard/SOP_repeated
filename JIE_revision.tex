...
\begin{multline}
  ...
  \label{ine:lob2}
\end{multline}
where Inequalities \ref{ine:leg2} and \ref{ine:lob2} are simple rearrangements of \ref{ine:leg} and \ref{ine:lob} with the conditions on the break level of effort explicitly incorporated into Inequality~\ref{ine:lob2}. Section~\ref{sec:structure} explores the structure of the equilibrium trade agreement given this problem faced by the executives.
...
Having fully described the strategies accompanying this punishment scheme, it must be shown that they constitute a public perfect equilibrium---that is, that the strategies constitute a subgame perfect Nash equilibrium from the start of each date and for each public history as well as within each period.
...
Begin by assuming the median legislature and lobby have identical patience levels of $0.95$ (i.e, $\de_{ML} = \de_L = 0.95$). Given the above specification of the economy, when $a=40$, the optimal punishment length is $T=4$ and $\tau^a = 0.09508$.
...
Finally, if $a=50$, corresponding to an increase in $\frac{\partial \ga}{\partial e}$, the lowest self-enforcing $\tau^a$ of $0.1394$ occurs when $T=3$, in line with Proposition~\ref{res:3}. As the lobby becomes more influential, shorter punishments achieve lower trade agreement tariffs.
