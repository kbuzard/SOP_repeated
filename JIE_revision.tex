...
Here, the lobby offers a contribution schedule of pairs of effort levels and tariff. Following \citet{dgh97}, I assume these pairs reflect the fact that the lobby has all the bargaining power in its relationship with the government. (can be very simple: just one $(e,\tau)$ pair, $e=0$ for everything else).
...
\vskip.2in
The structure of the trade-agreement-setting phase does not change (Section~\ref{sec:zero}). In the trade war, the government will be presented with a contribution schedule of lobbying effort, tariff pairs that can be denoted as a function $e(\tau)$. The government then maximizes $W_G(\tau,\tau^*,e(\tau))$ unilaterally.
...
\newpage
Optimal dispute settlement: depends on how government IC changes
			  \begin{multline}
