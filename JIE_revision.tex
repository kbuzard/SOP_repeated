...
\begin{multline}
  \mathrm{e}^{-r\Delta}\left(1-\mathrm{e}^{-r\Delta T}\right)\left[W_\text{ML}(\ga(e),\bta) - W_\text{ML}(\ga(e),\btw) \right] - \\ \left(1-\mathrm{e}^{-r\Delta}\right) \left[W_\text{ML}(\ga(e),\tau^b(e),\tau^{*a}) - W_\text{ML}(\ga(e),\bta) \right]   \geq 0
\end{multline}
\vskip-.4in
\begin{multline}
