...
Section~\ref{sec:eqm} then explains the way in which the trade agreement negotiation process selects a particular class of equilibria and describes that class of equilibria. I describe the structure of trade agreements in this environment in Section~\ref{sec:structure} and their properties in Section~\ref{sec:prop}. I then explore the forces shaping dispute resolution procedures in Section~\ref{sec:optimal}. Section~\ref{sec:asymmetric} explores an alternative punishment scheme. Section~\ref{sec:concl3} concludes.
