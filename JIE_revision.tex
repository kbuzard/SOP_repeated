...
\begin{equation}
	...
	\textstyle \frac{\left[1+ \frac{\de_\text{ML} - \de_\text{ML}^{T+1}}{1-\de_\text{ML}}  \right]\frac{\partial}{\partial \tau^a}W_\text{ML}(\ga(\ov{e}),\bta)} {\frac{\de_\text{ML} - \de_\text{ML}^{T+1}}{1-\de_\text{ML}}\frac{\partial \ga(\ov{e})}{\partial e}\left[ \pi_X(\tau^a) - \pi_X(\tau^{tw}) \right] - \frac{\partial \ga(\ov{e})}{\partial e}\left[ \pi_X(\tau^b(\ov{e})) - \pi_X(\tau^{a}) \right]}
	\label{eq:coret}
\end{equation}
...
\begin{equation}
 	\frac{\mathrm{d} \ov{e}}{\mathrm{d} \tau^{*a}} = -\frac{\frac{\partial \Omega}{\partial \tau^{*a}}}{\frac{\partial \Omega}{\partial \ov{e}}} = -
	\textstyle \frac{\frac{\de_\text{ML} - \de_\text{ML}^{T+1}}{1-\de_\text{ML}} \frac{\partial}{\partial \tau^{*a}}W_\text{ML}(\ga(\ov{e}),\bta)} {\frac{\de_\text{ML} - \de_\text{ML}^{T+1}}{1-\de_\text{ML}}\frac{\partial \ga(\ov{e})}{\partial e}\left[ \pi_X(\tau^a) - \pi_X(\tau^{tw}) \right] - \frac{\partial \ga(\ov{e})}{\partial e}\left[ \pi_X(\tau^b(\ov{e})) - \pi_X(\tau^{a}) \right]}
	\label{eq:corets}
\end{equation}
...
\begin{equation}
	...
	\textstyle \frac{\frac{\de_\text{ML} - \de_\text{ML}^{T+1}}{1-\de_\text{ML}}\left[ \pi_X(\tau^a) - \pi_X(\tau^{tw}) \right] - \left[ \pi_X(\tau^b(e)) - \pi_X(\tau^{a}) \right]}{\frac{\de_\text{ML} - \de_\text{ML}^{T+1}}{1-\de_\text{ML}}\frac{\partial \ga(\ov{e})}{\partial e}\left[ \pi_X(\tau^a) - \pi_X(\tau^{tw}) \right] -  \frac{\partial \ga(\ov{e})}{\partial e}\left[ \pi_X(\tau^b(e)) - \pi_X(\tau^{a}) \right]}
\end{equation}
...
\begin{equation*}
 	\frac{\mathrm{d} \ov{e}}{\mathrm{d} \tau^a} = -\frac{\frac{\partial \Omega}{\partial \tau^a}}{\frac{\partial \Omega}{\partial \ov{e}}} =
	\textstyle \frac{\frac{\partial}{\partial \tau^a}W_\text{ML}(\ga(\ov{e}),\bta)}{\frac{\partial \ga(\ov{e})}{\partial e}\left[ \pi_X(\tau^b(\ov{e})) - \pi_X(\tau^{a}) \right]} \hskip.5in 	\frac{\mathrm{d} \ov{e}}{\mathrm{d} \tau^{*a}} = -\frac{\frac{\partial \Omega}{\partial \tau^{*a}}}{\frac{\partial \Omega}{\partial \ov{e}}} = 
	\textstyle \frac{\frac{\de_\text{ML} - \de_\text{ML}^{T+1}}{1-\de_\text{ML}} \frac{\partial}{\partial \tau^{*a}}W_\text{ML}(\ga(e_a(\tau^a)),\bta)}{\frac{\partial \ga(\ov{e})}{\partial e}\left[ \pi_X(\tau^b(\ov{e})) - \pi_X(\tau^{a}) \right]}
\end{equation*}
...
\begin{multline}
 	\left(1 - \frac{\mathrm{d} \pi_X}{\mathrm{d} \ov{e}} \right) \frac{ -\frac{\de_\text{ML}^{T+1}\ln\de_\text{ML}}{1-\de_\text{ML}}\left[  W_\text{ML}(\ga(e_a(\tau^a)),\bta) - W_\text{ML}(\ga(e_{tw}),\btw) \right]}{\frac{\partial \ga(\ov{e})}{\partial e} \left[ \pi_X(\tau^b(\ov{e})) - \pi_X(\tau^a) \right]} \\
	+  \frac{\de_\text{L}^{T+1} \ln \de_\text{L}}{1-\de_\text{L}} \left[ \pi_X(\tau^{tw}) - e_{tw} -\pi_X(\tau^a) + e_a(\tau^a) \right]
	\label{eq:uniopt}
\end{multline}
