...
In Section~\ref{sec:stage}, I claim that the model presented in this paper can be interpreted as a special case of the general welfare function proposed in \citet{dgh97}. Here I substantiate that claim. Note that the following analysis makes the same non-unitary government assumption as in the main body of the paper, as distinct from the analysis in Section~\ref{sec:unitary} above.
