...
In each period of the repeated game, each lobby decides how much effort to exert to influence its respective legislature's tariff setting. Depending on lobbying effort, the legislatures then set the applied tariff levels.
