...
Although explicit expressions for the solution functions $\ov{e}(\cdot)$ and $\tau^a(\cdot)$ cannot be arrived at without imposing further assumptions, significant intuition can be derived implicitly. An overview of the results will be provided here, while the mathematical details are in the Appendix. It's important to keep in mind that these results apply to solutions that are truly interior in the sense that the lobby has been disengaged by making exerting effort too expensive.
