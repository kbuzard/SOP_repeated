...
\renewcommand\labelitemi{-}
	...
	\item \textit{I am very interested in the implications of disputes on the equilibrium path in this model and plan an extension of the mdoel to that case, as noted in the conclusion. In fact, my original plan for this paper was to include that case here. As things turned out it seems that it would overly burden the reader when the paper is already pressing the limits of what is reasonable in terms of length, and I do not want to risk the main points that are here being obscured.}
\end{itemize}
