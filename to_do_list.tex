...
\begin{itemize}
	\item Add to equilibrium selection argument that players condition only on tariff levels
		\begin{itemize}
			\item Also T is policy variable, determined by WTO-like actor
			\item PPE
			\item tariff cap
			\item etc.
		\end{itemize}
	...
	\item Be clear that a period is one play of the stage game
		\begin{itemize}
			\item Phase is one part of the stage game
		\end{itemize}
	\item Set up with: I'm looking at repeated game. Here's information set up. Discount factor. ...
\end{itemize}

\vskip.5in
Little fixes
\begin{itemize}
	\item Fix paragraph just below {eq:lobtw} for new eqm support and moving section {sec:nashrev}
\end{itemize}
