...
a = 40
etw <- uniroot(function(cn) 8/49*(1+(8*(2.26-exp(-a*cn))-5)/(68-8*(2.26-exp(-a*cn))))*(8*63)/((68-8*(2.26-exp(-a*cn)))^2)*a*exp(-a*cn)-1, lower=0, upper = .3, tol = 0.00001, maxiter = 1000)

# given trade war effort level, compute trade war tariff, 'ttw'
ttw = (8*(2.26 - exp(-a*etw$root))-5)/(68-8*(2.26 - exp(-a*etw$root)))
...
ta = seq(.097,.098,.000001) #possible bribe values for legislator located at 0
ea = -(1/a)*log((13.08-49.92*ta)/(8+8*ta))
...
f <- function (e) fd*(CSxta[j] + (2.26 - exp(-a*e))*PSxta[j] + CSyta[j] + PSyta[j] + TRta[j]) + (CSxta[j] + (2.26 - exp(-a*e))*PSxta[j] + CSyta[j] + PSyta[j] + TRta[j]) - fd*(CSxtw + (2.26 - exp(-a*e))*PSxtw + CSytw + PSytw + TRtw) - ((2.26 - exp(-a*e))*((2 +2*(8*(2.26 - exp(-a*e))-5)/(68-8*(2.26 - exp(-a*e))))^2)/49 + .5*((3 -4*(8*(2.26 - exp(-a*e))-5)/(68-8*(2.26 - exp(-a*e))))^2)/49 + (8*(2.26 - exp(-a*e))-5)/(68-8*(2.26 - exp(-a*e)))/7 - 6/7*((8*(2.26 - exp(-a*e))-5)/(68-8*(2.26 - exp(-a*e))))^2 + CSyta[j] + PSyta[j])
...
b1 = ((2 +2*(8*(2.26 - exp(-a*ove$root))-5)/(68-8*(2.26 - exp(-a*ove$root))))^2)/49
